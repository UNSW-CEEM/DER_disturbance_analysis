...
intall_data_file <- "GitHub/DER_disturbance_analysis/cumulative_capacity_and_number_20200218.csv"
...
type_table <- data.table(
  State = c('QLD', 'NSW', "VIC", "TAS", 'SA', 'QLD', 'NSW', "VIC", "TAS", 'SA'),
  Grouping =c('<30 kW', '<30 kW','<30 kW','<30 kW','<30 kW', 
...
write.csv(combined, "GitHub/DER_disturbance_analysis/cumulative_capacity_and_number_20200218_new.csv", row.names=FALSE)
