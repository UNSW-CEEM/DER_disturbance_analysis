...
testthat::test_that("Building works when there are extra headers in the ts data.",{
  ...
  timeseries_no_extra_header <- "data/smoke_timeseries.csv"
  site_details_path_name <- "data/smoke_site_details.csv"
  circuit_details_path_name <- "data/smoke_circuit_details.csv"
...
testthat::test_that("test circuit data cleaning, no cleaning required",{
    ...
    timeseries <- "data/smoke_timeseries.csv"
    site_details_path_name <- "data/smoke_site_details.csv"
    circuit_details_path_name <- "data/smoke_circuit_details.csv"
    circuit_details_path_name_clean <- "data/smoke_circuit_details_cleaned.csv"
    ...
    output_site_details <- dp$get_site_details_raw()
    output_circuit_details <- dp$get_circuit_details_raw()
    output_circuit_details_cleaned <- dp$get_circuit_details_cleaned()
