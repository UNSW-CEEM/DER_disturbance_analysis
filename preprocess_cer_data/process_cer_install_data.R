...
intall_data_file <- "C:/Users/NGorman/Documents/CER data/cer_sizegroup_install_data.csv"
...
type_table <- data.table(
  ...
  sizegroup =c('<30 kW', '<30 kW','<30 kW','<30 kW','<30 kW', '<30 kW', 
...
write.csv(combined, "C:/Users/NGorman/Documents/CER data/cer_sizegroup_install_data_no_gaps.csv", row.names=FALSE)
