...
ufls_statuses <- ufls_detection(db = db, region = 'NSW', 
                                ...
                                pre_event_window_length = 5,post_event_window_length = 9, 
                                pre_pct_sample_seconds_threshold = 0.6)

write.csv(ufls_statuses, as.character("Data/2021-05-25 QLD/1406/NSW_new_criteria_UFLS.csv"), row.names=FALSE)