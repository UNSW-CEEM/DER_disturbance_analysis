...
testthat::test_that("Building works when there are duplicates in ts data.", {
    ...
    dp$connect_to_new_database("test.db")
    dp$build_database(
        timeseries = timeseries_duplicates_path_name,
        circuit_details = circuit_details_path_name,
        site_details = site_details_path_name,
        check_dataset_ids_match = FALSE
    )
...
testthat::test_that("Test data cleaning with batch size smaller than number of circuits.", {
...
testthat::test_that(
    "Test calculating duration values works, with batch size smaller than number of circuits, more complex examples.",
{
...
testthat::test_that("test calculating duration values works, with batch size greater than the number of circuits", {
    timeseries_with_missing_durations <- "data/timeseries_with_missing_durations.csv"
    timeseries_expected_out <- "data/simple_timeseries.csv"
    site_details_path_name <- "data/simple_site_details.csv"
    site_details_cleaned_path_name <- "data/simple_site_details_cleaned.csv"
...
testthat::test_that("test calculating duration values works, with batch size equal to the number of circuits", {
    timeseries_with_missing_durations <- "data/timeseries_with_missing_durations.csv"
    timeseries_expected_out <- "data/simple_timeseries.csv"
    site_details_path_name <- "data/simple_site_details.csv"
    site_details_cleaned_path_name <- "data/simple_site_details_cleaned.csv"
